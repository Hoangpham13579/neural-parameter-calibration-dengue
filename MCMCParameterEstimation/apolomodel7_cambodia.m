...
load range/Range7_cambodia.mat
...
DataCambodia= readtable('data/data_cambodia.csv');
ydata=DataCambodia.CumulativeHumanInfected;
...
save('Result7_cambodia.mat','T7','res','xdata','ydata2')
