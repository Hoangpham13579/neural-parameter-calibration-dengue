...
load range/Range7_philippines.mat
...
DataPhilippines = readtable('data/data_philippines.csv');
ydata=DataPhilippines.CumulativeHumanInfected;
...
save('Result7_philippines.mat','T7','res','xdata','ydata2')
